                                            ...
                                            <div className="cart-item">
                                                ...
                                                <div className="cart-item-controls">
                                                    <div className="quantity-controls">
                                                        <button
                                                            onClick={() => decreaseQuantity(item.product._id || item.product.id)}
                                                        ...
                                                        />
                                                        <button
                                                            onClick={() => increaseQuantity(item.product._id || item.product.id)}
                                                            className="quantity-btn"
                                                        >
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            console.log("الـ item كامل:", item);
                                                            console.log("الـ product._id:", item.product._id);
                                                            console.log("الـ product.id:", item.product.id);
