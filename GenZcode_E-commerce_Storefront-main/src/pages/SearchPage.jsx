...
function SearchPage() {
    const { products, loading, setLoading, fetchProducts, totalProducts, limit, setProducts, setTotalProducts } = useProducts();
    ...
    useEffect(() => {
        ...
        const category = urlParams.get('category')?.trim() || ''; // مهم جدًا
    ...
    const endItem = totalProducts === 0 ? 0 : Math.min(currentPageNum * limit, totalProducts);
                    ...
                    <div className="col-lg-9 col-md-8">
                        ...
                        <div className="results-header">
                            <p className="results-count">
                                {totalProducts === 0 ? (
                                    <span className="text-muted">No products found in this category yet.</span>
                                ) : (
